...
import com.example.myhealth.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.myhealth.databinding.FragmentArticleBinding;
...
public class MyArticleRecyclerViewAdapter extends RecyclerView.Adapter<MyArticleRecyclerViewAdapter.ViewHolder> {
    ...
    private ArticleFragment.OnArticleSelected listener;
    int selectedIndex;

    public MyArticleRecyclerViewAdapter(List<Article> items, ArticleFragment.OnArticleSelected listener) {
        mValues = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(listener != null){
                    listener.articleSelected(holder.mItem);
